...
function preload(){
  ...
  bulletImg= loadImage('assets/download.png')
  bgSound=loadSound("assets/bgSound.wav")
  z1=loadAnimation("assets/b2.png","assets/b3.png","assets/b4.png")
  z2=loadAnimation("assets/g1.png","assets/g2.png","assets/g3.png","assets/g4.png")
  z3=loadAnimation("assets/w1.png","assets/w2.png","assets/w3.png","assets/w4.png")
  z4=loadAnimation("assets/y1.png","assets/y2.png","assets/y3.png","assets/y4.png")
}
...
function enemy(){
  if(frameCount%80===0){
    ...
    switch(r){
    case 1 : zombie.addAnimation("zombie1",z1)
    break;
    case 2 : zombie.addAnimation("zombie2",z2)
    break;
    case 3 : zombie.addAnimation("zombie3",z3)
    break;
    case 4 : zombie.addAnimation("zombie4",z4)
    break;
    default:break;
    }
    zombie.debug= false
